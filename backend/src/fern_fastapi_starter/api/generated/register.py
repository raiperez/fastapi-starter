...
from .resources.hero_sim.service.service import AbstractHeroSimService


def register(_app: fastapi.FastAPI, *, hero_sim: AbstractHeroSimService) -> None:
    _app.include_router(__register_service(hero_sim))
